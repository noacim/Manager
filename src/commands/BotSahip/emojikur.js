module.exports = {
  ...
  run: async (client, message, args) => {
    const emojis = [
        ...
        { name : "noaspotify", url: "https://cdn.discordapp.com/emojis/899337292840312912.png?size=44"},
        { name : "noanetflix", url: "https://cdn.discordapp.com/emojis/899337280790077491.png?size=44"},
        { name : "noaexxen", url: "https://cdn.discordapp.com/emojis/900396713116835900.png?size=44"},
        { name : "noablutv", url: "https://cdn.discordapp.com/emojis/900396707362246666.png?size=44"},
        { name : "noanitro", url: "https://cdn.discordapp.com/emojis/899337278047006831.png?size=44"}
    ]
