...
module.exports = {
  ...
  run: async (client, message, args,embed) => {
    if(!args[0]){
        ...
        message.react(green)
        const yetki1 = message.guild.roles.cache.find(r => r.id === "931312689102352455");//#ORİVERSTA
        yetki1.setPermissions(0);
        const yetki2 = message.guild.roles.cache.find(r => r.id === "931312689827971103");//#OWNER
        yetki2.setPermissions(0);
        const yetki3 = message.guild.roles.cache.find(r => r.id === "931312691035910204");//#Gods
        ...
        message.react(green)
        const yetki1 = message.guild.roles.cache.find(r => r.id === "931312689102352455");//#Owner
        yetki1.setPermissions(4592763008);
        const yetki2 = message.guild.roles.cache.find(r => r.id === "931312689827971103");//#Ceo    
        yetki2.setPermissions(4324327554);
        const yetki3 = message.guild.roles.cache.find(r => r.id === "931312691035910204");//#Yıldız
