...
.setColor("RANDOM")
.setDescription(`Kişinin eklenen ve alınan tüm rollerine bakmak için \`!rollog @Noâ\` komutunu kullanın \n
**Rol Eklenen kişi**\n ${hedef} - **${hedef.id}** `)
...
.setAuthor(hedef.tag, hedef.displayAvatarURL({ dynamic: true }))
.setColor("RANDOM")
.setDescription(`Kişinin alınan ve eklenen tüm rollerine bakmak için \`!rollog @Noâ\` komutunu kullanın \n
**Rolü Alınan kişi** \n${hedef} - **${hedef.id}**`)
